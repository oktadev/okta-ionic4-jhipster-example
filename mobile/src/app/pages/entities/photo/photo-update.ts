...
export class PhotoUpdatePage implements OnInit {
    ...
    ngOnInit() {
        this.albumService.query()
            .subscribe(data => { this.albums = data.body; }, (error) => this.onError(error));
    ...
    protected subscribeToSaveResponse(result: Observable<HttpResponse<Photo>>) {
        result.subscribe((res: HttpResponse<Photo>) => this.onSaveSuccess(res), (res: HttpErrorResponse) => this.onError(res.error));
    }
    ...
    async onSaveSuccess(response) {
        ...
        toast.present();
        this.navController.navigateBack('/tabs/entities/photo');
    }
