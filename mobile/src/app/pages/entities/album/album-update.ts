...
export class AlbumUpdatePage implements OnInit {
    ...
    protected subscribeToSaveResponse(result: Observable<HttpResponse<Album>>) {
        result.subscribe((res: HttpResponse<Album>) => this.onSaveSuccess(res), (res: HttpErrorResponse) => this.onError(res.error));
    }
    ...
    async onSaveSuccess(response) {
        ...
        toast.present();
        this.navController.navigateBack('/tabs/entities/album');
    }
